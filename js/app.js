...
var reid = new re2.exec(window.location.href);
function Create(inputtext, id) {
    ...
    var createpost = $.ajax({
        ...
        beforeSend: function (request) {
            request.setRequestHeader('Accept:application/json', 'x-auth-token:' + token[1]);
        },
